...
export default function Services() {
  ...
  const services = [
    ...
    },
    {
      ...
      description: 'Segunda a sexta (7h às 22h) e sábados (9h às 16h).',
      ...
      details: [
        'Aberto de segunda a sexta das 7h às 22h (sem fechar ao meio dia)',
        'Sábados das 9h às 16h',
        'Domingo: Fechado',
        'Sem fechar ao meio dia (Seg-Sex)',
        'Acesso ilimitado durante o horário de funcionamento',
      ],
    },
